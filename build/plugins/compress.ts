...
/**
 * Configures the compression plugin for Vite build process.
 * @descCN 根据 compress 配置，生成不同的压缩规则
 ...
 */
export function configCompressPlugin(viteEnv: Env.ImportMeta): PluginOption | PluginOption[] {
